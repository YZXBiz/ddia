...
>
> _St. Thomas Aquinas, Summa Theologica (1265–1274)_
...
3. **Event-time windowing**: When reprocessing historical data, processing time is meaningless—you need to window by the timestamp in the event itself
...
<DiagramContainer title="Uniqueness Constraints Need Consensus">
  <Row gap="lg">
    <Column gap="md">
      ...
      <Row gap="sm">
        <Box color={colors.orange} size="sm">User A → username "alice"</Box>
        <Box color={colors.orange} size="sm">User B → username "alice"</Box>
      </Row>
      <Box color={colors.red} variant="subtle" size="sm">
...
<ProcessFlow
  steps={[
    { title: "Encode Requests", description: "Username requests → messages", color: colors.blue },
...
<ComparisonTable
  ...
  items={[
    ...
    { label: "Resolution", before: "Wait and retry → fixed", after: "Requires explicit checking & repair" },
  ...
  <Row gap="lg">
    ...
    <Column gap="md">
      ...
      <Box color={colors.red} variant="subtle" size="sm">
        ...
        ✗ Catastrophic for trust & legal reasons
      </Box>
    </Column>
  </Row>
</DiagramContainer>
...
**Previous:** [Chapter 12: Stream Processing](/ddia/part3/chapter12-stream-processing) | **Next:** [Chapter 14: Ethics](/ddia/part3/chapter14-ethics)
