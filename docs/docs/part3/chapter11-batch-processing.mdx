...
<DiagramContainer title="THREE STYLES OF DATA PROCESSING">
  <Row gap={40} align="start">
    <Column gap={15}>
      ...
      <Column gap={10}>
        <div style={{fontSize: '14px', textAlign: 'center'}}>Request → Response</div>
    ...
    <Column gap={15}>
      ...
      <Column gap={10}>
        <div style={{fontSize: '14px', textAlign: 'center'}}>Input → Output</div>
    ...
    <Column gap={15}>
      ...
      <Column gap={10}>
        <div style={{fontSize: '14px', textAlign: 'center'}}>Event → Action</div>
...
<DiagramContainer title="SINGLE MACHINE vs. DISTRIBUTED BATCH SYSTEM">
  <Row gap={60} align="start">
    ...
    <div style={{alignSelf: 'center', fontSize: '24px'}}>→</div>
...
<DiagramContainer title="DISTRIBUTED FILESYSTEM ARCHITECTURE">
  <Column gap={30}>
    <Box color={colors.blue} label="NameNode / Metadata Service (file→blocks)" padding={15} />
    <Arrow direction="down" />
    <Row gap={30}>
      <Column gap={10}>
  ...
  <Column gap={20}>
    <Box color={colors.blue} label="SCHEDULER" padding={15}>
      <div style={{fontSize: '12px', marginTop: '8px'}}>
        • Receives job requests<br/>
        • Decides which tasks run on which nodes<br/>
    ...
    <Box color={colors.green} label="RESOURCE MANAGER" padding={15}>
      <div style={{fontSize: '12px', marginTop: '8px'}}>
        • Tracks all nodes and their resources (CPU, GPU, memory)<br/>
        • Maintains global cluster state in ZooKeeper/etcd<br/>
...
<DiagramContainer title="SORT-MERGE JOIN">
  <Column gap={20}>
    ...
    <Box color={colors.purple} label="REDUCER FOR user_id=123:" padding={12}>
      <div style={{fontSize: '12px', marginTop: '5px'}}>
        1. User profile: {'{'}birth_date: 1990, name: Alice{'}'} ← arrives first<br/>
  ...
  <Column gap={30}>
    ...
    <div>
      ...
      <Box color={colors.blue} label="Cloud Data Platforms (BigQuery, Snowflake, Databricks)" padding={15}>
        <div style={{fontSize: '12px', marginTop: '8px'}}>
          • SQL + DataFrame APIs<br/>
          • Columnar storage (Parquet)<br/>
          • Distributed shuffle<br/>
          • Object storage (S3) as foundation<br/>
