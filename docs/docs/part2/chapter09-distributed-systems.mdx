...
<DiagramContainer title="Single Node vs. Distributed System Failures">
  <Row gap="lg">
    ...
    <Group title="Distributed System" color={colors.purple}>
      <Column gap="md">
        <Row gap="sm">
          <Box color={colors.green} size="sm">Node 1 ✓</Box>
          <Box color={colors.green} size="sm">Node 2 ✓</Box>
          <Box color={colors.green} size="sm">Node 3 ✓</Box>
        </Row>
        <Arrow direction="down" label="Partial Fault" />
        <Row gap="sm">
          <Box color={colors.green} size="sm">Node 1 ✓</Box>
          <Box color={colors.red} size="sm">Node 2 ✗</Box>
          <Box color={colors.green} size="sm">Node 3 ✓</Box>
        </Row>
      </Column>
    </Group>
  ...
  <Column gap="lg">
    <Group title="Scenario A: Request Lost" color={colors.red}>
      <Row gap="md">
        ...
        <Arrow direction="right" label="Request ✗" color={colors.red} />
    ...
    <Group title="Scenario C: Response Lost" color={colors.red}>
      <Row gap="md">
        <Box color={colors.blue}>Client</Box>
        <Arrow direction="left" label="Response ✗" color={colors.red} />
  ...
  <StackDiagram
    ...
    layers={[
      ...
      },
      {
        label: "Switch Queue",
        color: colors.purple,
        items: ["Multiple senders → same destination", "Queue fills up, packets dropped"]
      },
      {
