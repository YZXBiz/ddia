...
Every write to the database needs to be processed by every replica; otherwise, the replicas would no longer contain the same data. The most common solution is called leader-based replication, primary-backup, or active/passive. It works as follows:
...
<DiagramContainer title="Causality Violation in All-to-All Topology">
  <ProcessFlow
    steps={[
      ...
      { title: "Leader 2 receives INSERT", description: "Too late—causality violated", color: colors.orange }
    ]}
  />
</DiagramContainer>
...
<CardGrid
  ...
  cards={[
    ...
    },
    {
      ...
      icon: "📴",
      color: colors.blue,
      description: "No separate offline mode needed—being offline is just very large network delay. Critical for mobile."
    },
    {
...
<DiagramContainer title="Write Conflict in Multi-Leader Replication">
  <Row gap="lg">
    <Column>
      ...
      <Arrow direction="down" label="title: A → B" />
    ...
    <Column>
      ...
      <Arrow direction="down" label="title: A → C" />
...
<DiagramContainer title="Amazon Shopping Cart Anomaly">
  <ProcessFlow
    steps={[
      ...
      { title: "Merge by union", description: "Cart: {Soap, Book, DVD} — items reappear!", color: colors.red }
    ]}
  />
</DiagramContainer>
...
<DiagramContainer title="Quorum Reads and Writes">
  <Column gap="lg">
    ...
    <Group title="Write (w=3)" color={colors.green}>
      <Row gap="sm">
        <Box color={colors.green} size="sm">✓ Rep 1</Box>
        <Box color={colors.green} size="sm">✓ Rep 2</Box>
        <Box color={colors.green} size="sm">✓ Rep 3</Box>
    ...
    <Group title="Read (r=3)" color={colors.blue}>
      <Row gap="sm">
        ...
        <Box color={colors.blue} size="sm">✓ Rep 3</Box>
        <Box color={colors.blue} size="sm">✓ Rep 4</Box>
        <Box color={colors.blue} size="sm">✓ Rep 5</Box>
      </Row>
    </Group>
    <Box color={colors.orange}>Overlap: Replica 3 has latest value → Read succeeds!</Box>
  </Column>
</DiagramContainer>
...
<ProcessFlow
  steps={[
    ...
    { title: "Server: Overwrite or keep siblings", description: "Overwrite all values ≤ version; keep values > version as siblings", color: colors.orange }
  ]}
/>
